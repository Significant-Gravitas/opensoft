from flywheel.battleship.abstract_class import AbstractBattleship, Game, TurnResponse, GameStatus, ShipPlacement, Turn
...
class Battleship4(AbstractBattleship):
    ...
    def get_winner(self, game_id: str) ->str:
        return "Player 1" if len(self.games[game_id].turns
            ) % 2 == 0 else "Player 2"
