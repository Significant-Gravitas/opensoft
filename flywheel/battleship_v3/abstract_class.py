...
#
#
# class Player(SQLModel, table_name="battleship_v3_player"):
#     id: int = Field(default=None, primary_key=True)
#     name: str
#
#
# class Game(SQLModel, table="battleship_v3_game"):
#     id: int = Field(default=None, primary_key=True)
...
#
#
# class ShipPlacement(SQLModel, table_name="battleship_v3_ship_placement"):
#     id: int = Field(default=None, primary_key=True)
...
#
#
# class Turn(SQLModel, table="battleship_v3_turn"):
#     id: int = Field(default=None, primary_key=True)
#     game_id: int = Field(foreign_key="game.id")
#     target_row: int
#     target_column: str
...
#
#
# class AbstractBattleshipV3(ABC, BaseClass):
#     SHIP_LENGTHS = {
#         "carrier": 5,
#         "battleship": 4,
#         "cruiser": 3,
