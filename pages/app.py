...
base_dir = Path(__file__).parent  # Now pointing to the 'pages' directory
modules = [
    d.name for d in base_dir.iterdir() if d.is_dir()
]  # List all directories under 'pages' as modules
...
for module_name in modules:
    ...
    for version in versions:
        ...
        for backend_iteration in backend_iterations:
            ...
            dynamic_path = f"pages.{module_name}.{version}.{backend_iteration}.endpoint"
