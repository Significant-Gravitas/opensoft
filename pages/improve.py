...
from pages.utils.common import IMPLEMENTATION_NUMBER, print_file_content
from pages.utils.pytest_failure import get_nth_failure
...
def run(module, command, pick_item, result_only):
    ...
    if result_only:
        ...
        result_str = print_file_content(f"pages/{module}/models.py")
        result_str += print_file_content(
            f"pages/{module}/implementations/{module}_{IMPLEMENTATION_NUMBER}.py"
        )
        result_str += print_file_content(f"pages/{module}/tests/conftest.py")
