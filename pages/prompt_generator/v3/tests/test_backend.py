...
@pytest.mark.asyncio
async def test_prompt_creation_frontend(client: AsyncClient):
    response = await client.post(
        "/prompts",
        json={"module_backend": "module_fixture/v1/b1", "goal": "pass_frontend_tests"},
    )
    ...
    # Add checks that are relevant to your frontend tests
