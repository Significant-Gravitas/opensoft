...
for module_name in modules:
    ...
    for version in versions:
        ...
        backend_iterations = [folder.name for folder in all_folders if pattern.match(folder.name)]
        ...
        for backend_iteration in backend_iterations:
            ...
            app.include_router(getattr(module, "router"), prefix=f"/{version}/{backend_iteration}")
