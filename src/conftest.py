...
def pytest_generate_tests(metafunc):
    if "user_feedback_v2" not in str(metafunc.module) and "crud_module_v1" not in str(metafunc.module)  and "crud_module_v2" not in str(metafunc.module) and "crud_module_v3" not in str(metafunc.module) and "file_renamer_v1" not in str(metafunc.module):
