...
@crud_module_v1_router.get("/v1/modules/")
def get_modules() -> List[ModuleRead]:
    return get_all_modules()

@crud_module_v1_router.get("/v1/modules/{module_name}/")
...
@crud_module_v1_router.post("/v1/modules/", response_model=ModuleRead)
...
@crud_module_v1_router.delete("/v1/modules/{module_name}/")
