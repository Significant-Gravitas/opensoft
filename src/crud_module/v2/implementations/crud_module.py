...
from src.crud_module.v2.abstract_class import ModuleCreate, ModuleRead
...
@crud_module_v2_router.get("/modules/")
def get_modules() -> List[ModuleRead]:
    return get_all_modules()

@crud_module_v2_router.get("/modules/{module_name}/")
...
@crud_module_v2_router.post("/modules/", response_model=ModuleRead)
...
@crud_module_v2_router.delete("/modules/{module_name}/")
