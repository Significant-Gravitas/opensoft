...
@crud_module_v3_router.get("/modules/")
def get_modules() -> List[ModuleRead]:
    return get_all_modules()

@crud_module_v3_router.get("/modules/{module_name}/")
...
@crud_module_v3_router.post("/modules/", response_model=ModuleRead)
...
@crud_module_v3_router.delete("/modules/{module_name}/")
