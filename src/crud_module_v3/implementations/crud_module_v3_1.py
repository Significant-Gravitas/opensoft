...
from src.crud_module_v3.abstract_class import ModuleCreate, ModuleRead

crud_module_v3_router = APIRouter()
...
@crud_module_v3_router.get("/v3/modules/")
def get_modules() -> List[ModuleRead]:
    return get_all_modules()

@crud_module_v3_router.get("/v3/modules/{module_name}/")
...
@crud_module_v3_router.post("/v3/modules/", response_model=ModuleRead)
...
@crud_module_v3_router.delete("/v3/modules/{module_name}/")
