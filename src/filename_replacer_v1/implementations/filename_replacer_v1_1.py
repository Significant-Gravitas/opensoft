...
from src.filename_replacer_v1.abstract_class import ModuleCreate, ModuleRead
...
@filename_replacer_v1_router.get("/v1/modules/")
def get_modules() -> List[ModuleRead]:
    return get_all_modules()

@filename_replacer_v1_router.get("/v1/modules/{module_name}/")
...
@filename_replacer_v1_router.post("/v1/modules/", response_model=ModuleRead)
...
@filename_replacer_v1_router.delete("/v1/modules/{module_name}/")
