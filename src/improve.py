...
from src.utils.common import IMPLEMENTATION_NUMBER, print_file_content
from src.utils.pytest_failure import get_nth_failure
...
def run(module, command, pick_item, result_only):
    ...
    if result_only:
        ...
        result_str += print_file_content(f"src/{module}/tests/conftest.py")
